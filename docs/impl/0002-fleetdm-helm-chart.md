...
- [x] Verify all values in `charts/fleetdm/values.yaml` have `# --` annotations (should
  already be done in Phase 1, but verify completeness)
- [x] Create `charts/fleetdm/README.md.gotmpl` with:
...
- [x] Run `make helm-docs` to generate `charts/fleetdm/README.md`
- [x] Run `make helm-docs-check` to verify docs are in sync
- [x] Verify generated README looks correct and all values are documented
